...
"""
from .widget import FastWidget, BetWidget, FslAnatWidget, FslMathsWidget, FslAtlasWidget
...
QP_MANIFEST = {
    "widgets" : [FastWidget, BetWidget, FslAnatWidget, FslMathsWidget, FslAtlasWidget],
